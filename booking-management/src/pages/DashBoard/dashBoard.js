        ...
        (async () => {
            try {
                ...
                if(userParse.role === "isCompany"){
                    await statisticApi.getTotalByCompany().then((res) => {
                        console.log(res);
                        setTotalList(res)
            ...
            <Spin spinning={false}>
                <div className='container'>
                    ...
                    <Row gutter={12} style={{ marginTop: 20 }}>
                        ...
                        <Col span={6}>
                            <Card className="card_total" bordered={false}>
                                <div className='card_number'>
                                    <div>
                                        <div className='number_total'>{statisticList?.hotelTotal}</div>
                                        <div className='title_total'>Số khách sạn</div>
                                    </div>
                                    <div>
                        ...
                        <Col span={6}>
                            <Card className="card_total" bordered={false}>
                                <div className='card_number'>
                                    <div>
                                        <div className='number_total'>{statisticList?.tourTotal}</div>
                                        <div className='title_total'>Số Tour</div>
                                    </div>
                                    <div>
                            ...
                            <Card className="card_total" bordered={false}>
                                <div className='card_number'>
                                    <div>
                                        ...
                                        <div className='title_total'>Số đặt chỗ</div>
                                    </div>
                                    <div>
                    ...
                    <Row gutter={12}>
                        <Col span={12}>
                            <div className="chart">
                                <div className="title">Thống kê đặt chỗ trong 12 tháng</div>
                        ...
                        <Col span={12}>
                            <div className='chart'>
                                <div className="title">Đặt chỗ mới nhất</div>
