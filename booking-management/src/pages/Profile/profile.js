    ...
    useEffect(() => {
        (async () => {
            try {
                ...
                const userEmail = JSON.parse(userLocal);

                const response = await userApi.getProfile(userEmail._id);
                        ...
                        <Row justify="center">
                            <Col span="9" style={{ marginTop: 20, marginLeft: 20, marginRight: 20 }}>
                                <Card hoverable={true} className="profile-card" style={{ padding: 0, margin: 0 }}>
                                    <Row justify="center">
                                        {userData.image ? 
                                        <img src={userData?.image} style={{ width: 150, height: 150 }}></img> : <img src="https://zos.alipayobjects.com/rmsportal/ODTLcjxAfvqbxHnVXCYX.png" style={{ width: 150, height: 150 }}></img>}
                                    </Row>
                                    <Row justify="center">
                                        <Col span="24">
                                            <Row justify="center">
